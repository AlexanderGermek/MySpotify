...
final class AuthManager {
    ...
    struct Constants {
        static let clientID     = "7f0cdbd953114910b9617f975f124152"
        static let clientSecret = "fd5a65f426d141e2a5e56fe406cf5bcd"
...
//                let json = try JSONSerialization.jsonObject(with: data, options: .allowFragments)
    ...
    public func withValidToken(completion: @escaping (String) -> Void) {
        ...
        if shouldRefreshToken {
            //refresh
            refreshAccessTokenIfNedded { [weak self] (success) in
    ...
    public func refreshAccessTokenIfNedded(completion: ((Bool) -> Void)?) {
        guard !refreshingToken else {
            return
        }
